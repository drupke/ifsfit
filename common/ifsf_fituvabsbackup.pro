...
;
;-
pro ifsf_fituvabsbackup,initfile,directoryname,galaxyname,doublet,cols=cols,rows=rows,nsplit=nsplit,verbose=verbose,$
   ...
   readcol, directoryname+galaxyname+doublet+'param', profileshifts, profilesig, coveringfactor, opticaldepth, FORMAT='(A,D,D,D,D)'
