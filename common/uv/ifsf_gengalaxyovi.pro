FUNCTION IFSF_GENGALAXYOVI, directoryname, gal, zgal, profileshifts, profilesig, coveringfactor,$
...
; Finding the index to fit over
  lines=CALL_FUNCTION('ifsf_linelist',['[OVI1]1032','[OVI2]1038'])
...
;    INDGEN(VALUE_LOCATE(wavelength,1346.7)-VALUE_LOCATE(wavelength,1345.6),START=VALUE_LOCATE(wavelength,1345.6)),$
    INDGEN(N_ELEMENTS(wavelength)-VALUE_LOCATE(wavelength,1287.5),START=VALUE_LOCATE(wavelength,1287.5))]
;  weight=1d/error^2
...
;  fitargs['reg7'] = {argsbkpts:{everyn:195}}
  graphic1=PLOT(wavelength,flux, XRANGE=checkindex)
  ;flux=CALL_FUNCTION('ifsf_fitspline', wavelength, flux, weight, ignored, indextoplot,0,argsbkpts={everyn:12})
;  continuum=CALL_FUNCTION('ifsf_fitmulticont', wavelength, flux, weight, ignored, indextoplot,0,fitreg=fitreg,$
  ...
  graphic2=PLOT(wavelength,continuum, XRANGE=graphic1.XRANGE,YRANGE=graphic1.YRANGE,Position=graphic1.Position,/CURRENT)
...
;  nadem_siglim = [299792d/3000d/2.35d,750d]
  ...
  initnad = {$
    argsnadweq: {autowavelim: [1200,1320,1321,1325],$
    autoindices:1},$
    plotindex:plotrange,$
    fitindex:fitrange,$
