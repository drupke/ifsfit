...
;
;-
function ifsf_inituvabsovi,initnadabs,initnadem,siglimnadabs,siglimnadem,$
                      taumax=taumax,$
...
;     Labels
      ...
      parinfo[ind_w].parname = 'wavelength'
      parinfo[ind_s].parname = 'sigma'
      parinfo[ilo:ilo+nnadabs*4-1].line = '[OVI1]1032'
...
;     Labels
      ...
      parinfo[ilo:ilo+nnadem*4-1].line = '[OVI1]1032'
