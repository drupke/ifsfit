...
;
;-
function ifsf_inituvabsNV,initnadabs,initnadem,siglimnadabs,siglimnadem,$
                      taumax=taumax,$
...
;     Labels
      ...
      parinfo[ind_w].parname = 'wavelength'
      parinfo[ind_s].parname = 'sigma'
      parinfo[ilo:ilo+nnadabs*4-1].line = '[NV1]1239'
...
;     Labels
      ...
      parinfo[ilo:ilo+nnadem*4-1].line = '[NV1]1239'
