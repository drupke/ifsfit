function lris_initparinfo,linename,linelambda,linelambdaz,initflux,$
                          initsig,z,stitchwave=stitchwave,zfix=zfix
;
...
; main velocity component
  for iline=0, nline-1 do begin
     ...
     if (linelambda[iline] lt stitchwave) then parinfo[iwoff].tied = $
        ...
        string(linelambda[iline],'-',z.blueint,format='(D0.2,A0,D0.2)')+'))' $
     else $
