...
;name = 'IRASF01053-1746'

redz = '0.20'

cuber = '/Users/jrich/wifes/cubes/'+name+'_R7_res_t_z'+redz+'.fits'
cubeb = '/Users/jrich/wifes/cubes/'+name+'_B3_res_t_z'+redz+'.fits'



;if n_elements(red) eq 0 then 
red = wifes_readcube(cuber,wave_red,err_red)
;if n_elements(blue) eq 0 then 
blue = wifes_readcube(cubeb,wave_blue,err_blue)
...
plotname= name+'_f'+strcompress(long(diam),/remove_all)+'_'+strcompress(long(xcen),/remove_all)+'_'+strcompress(long(ycen),/remove_all)+'_z'+redz+'_fiber.ps'
...
corners = cornerscircle(diam,xcen,ycen)

oplot,corners[*,0],corners[*,1]
...
sxaddpar,hdrimr,'CD1_1',diam
sxaddpar,hdrerrr,'CD1_1',diam
sxaddpar,hdrimb,'CD1_1',diam
sxaddpar,hdrerrb,'CD1_1',diam
...
redname = name+'_f'+strcompress(long(diam),/remove_all)+'_'+strcompress(long(xcen),/remove_all)+'_'+strcompress(long(ycen),/remove_all)+'_z'+redz+'_r.fits'
bluename= name+'_f'+strcompress(long(diam),/remove_all)+'_'+strcompress(long(xcen),/remove_all)+'_'+strcompress(long(ycen),/remove_all)+'_z'+redz+'_b.fits'
